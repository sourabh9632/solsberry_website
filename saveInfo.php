...
$data_fields = array(
	...
	'00N2v00000GtoQD' => 'C - OS', // project_name
	'retURL' => 'https://www.bangalore-projects.com/projects/solsberry_website/',
	'last_name' => $name,
	'mobile' => $mobile,
	'email' => $email,
	// '00N2u000000qreq' => '',
...
$url = 'https://webto.salesforce.com/servlet/servlet.WebToLead?encoding=UTF-8&orgId=00D2v000000N0r0';
...
curl_setopt_array($curl, array(
  ...
  CURLOPT_POSTFIELDS => http_build_query($data_fields),
